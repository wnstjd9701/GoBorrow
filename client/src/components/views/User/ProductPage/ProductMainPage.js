              ...
              <Card sx={{ display: 'inline-block', margin: '5px 30px', minWidth: '30vw' }}>
                <CardContent sx={{ padding: '30px' }}>
                  ...
                  <RadioGroup aria-labelledby="demo-radio-buttons-group-label" defaultValue="female" name="radio-buttons-group">
                    <FormControlLabel style={{ margin: '5px 0 10px' }} value="접이식 우산(UR1022)" control={<Radio />} label="UR1022" />
                    <FormControlLabel style={{ margin: '0 0 10px' }} value="투명 장우산(UR1023)" control={<Radio />} label="UR1023" />
                    <FormControlLabel style={{ margin: '0 0 10px' }} value="블랙 장우산(UR1024)" control={<Radio />} label="UR1024" />
                  </RadioGroup>
