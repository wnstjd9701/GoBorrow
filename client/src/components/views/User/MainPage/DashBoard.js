  ...
  return (
    <Box maxWidth="md" style={{ margin: '30px auto' }} sx={{ flexGrow: 1 }}>
      <Grid style={{ justifyContent: 'center' }} container spacing={2}>
          ...
          <div>
            <Accordion expanded={expanded === 'panel1-3'} onChange={handleChange('panel1-3')}>
              ...
              <AccordionDetails>
                <Typography style={{ fontSize: '0.9rem' }}>
                  <b>제품 코드:</b> UR2023 <br />
                  <b>대여 기간:</b> 2022-06-08 ~ 2022-06-10 <br />
                  <b>대여 시간:</b> 23:00 <br />
                  <b>반납 시간:</b> 12:00 <br />
                </Typography>
              </AccordionDetails>
            ...
            <Accordion expanded={expanded === 'panel1-1'} onChange={handleChange('panel1-1')}>
              ...
              <AccordionDetails>
                <Typography style={{ fontSize: '0.9rem' }}>
                  <b>제품 코드:</b> 44043 <br />
                  <b>대여 기간:</b> 2022-06-10 ~ 2022-06-17 <br />
                  <b>대여 시간:</b> 12:00 <br />
                  <b>반납 시간:</b> 14:00 <br />
                </Typography>
              </AccordionDetails>
            ...
            <Accordion expanded={expanded === 'panel1-2'} onChange={handleChange('panel1-2')}>
              ...
              <AccordionDetails>
                <Typography style={{ fontSize: '0.9rem' }}>
                  <b>제품 코드:</b> R203 <br />
                  <b>대여 기간:</b> 2022-06-12 ~ 2022-06-12 <br />
                  <b>대여 시간:</b> 12:30 <br />
                  <b>반납 시간:</b> 17:30 <br />
                </Typography>
              </AccordionDetails>
        ...
        <Grid style={{ minWidth: 300, maxWidth: 360 }} item xs={4}>
          <div style={{ margin: '20px auto', textAlign: 'center', fontSize: 16, fontWeight: 'bold' }}>대여 진행</div>{' '}
          <div>
            <Accordion expanded={expanded === 'panel2-3'} onChange={handleChange('panel2-3')}>
              ...
              <AccordionDetails>
                <Typography style={{ fontSize: '0.9rem' }}>
                  <b>제품 코드:</b> UR1022 <br />
                  <b>대여 기간:</b> 2022-06-07 ~ 2022-06-13 <br />
                  <b>반납 시간:</b> 17:30
                </Typography>
              </AccordionDetails>
            </Accordion>
